...
public class DialPuzzle : MonoBehaviour
{
    ...
    //Combinations
    [HideInInspector]
    public enum Combinations { WXYZ, WYZX, XWYZ, YWZX, YWXZ, ZWYX, WYXZ, WZYX, XYWZ, YZWX, YXWZ, ZYWX, ZXWY, ZYXW, XZWY, YZXW, WZXY, XZYW, ZWXY, ZXYW, XWZY, YXZW, WXZY, XYZW, NUM25, NUM26, NUM27, NUM28, NUM29, NUM30}
    [HideInInspector]
